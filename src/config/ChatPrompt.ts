...
SKILLS: ${skillNames}
ADDITIONAL EXPERTISE: LLM Fine-tuning (Tiny-LLaMA), RAG Pipelines, AI Agents, n8n Workflow Automation, Docker, CI/CD, Nginx, Linux Server Management, Arduino IoT + LLM Integration, WhatsApp Business Automation (WAHA), Web Scraping
...
- Focus on Shivam Kaushal's expertise in full-stack development AND AI/LLM work
- For work inquiries, direct to email: [shivamkasuhal181@gmail.com](mailto:shivamkasuhal181@gmail.com), LinkedIn: [LinkedIn](https://www.linkedin.com/in/shivam-kaushal-9b825a269/)
...
export const chatSuggestions = [
  ...
  'Tell me about your AI & LLM projects',
